...
def clean_usda_data():
    ...
    for food in foods:
        ...
        record = {
            ...
            'sugar_g': nutrients.get('Sugars, Total', {}).get('amount'),
            'sodium_mg': nutrients.get('Sodium, Na', {}).get('amount'),
            'calcium_mg': nutrients.get('Calcium, Ca', {}).get('amount'),
            'iron_mg': nutrients.get('Iron, Fe', {}).get('amount'),
            'magnesium_mg': nutrients.get('Magnesium, Mg', {}).get('amount'),
            'potassium_mg': nutrients.get('Potassium, K', {}).get('amount'),
            'zinc_mg': nutrients.get('Zinc, Zn', {}).get('amount'),
